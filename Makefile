...
DASH_CAPSULE_FRONTIER_WINDOW ?= 96
DASH_CAPSULE_MINT_PARENT_POOL ?= 16
DASH_SEASON_TOPOLOGY_JITTER ?= 0.03
DASH_CHAOS_MIN_SUBSTEPS ?= 1
DASH_CHAOS_MAX_SUBSTEPS ?= 64
DASH_CHAOS_SUBSTEP_COST ?= 0.004
...
help:
	...
	@echo "  DASH_WORLD_VOCAB=50257 DASH_WORLD_LEN=9213908"
	...
	@echo "  DASH_CAPSULE_FRONTIER_WINDOW=96 DASH_CAPSULE_MINT_PARENT_POOL=16"
	@echo "  DASH_SEASON_TOPOLOGY_JITTER=0.03"
	@echo "  DASH_CHAOS_MIN_SUBSTEPS=1 DASH_CHAOS_MAX_SUBSTEPS=64 DASH_CHAOS_SUBSTEP_COST=0.004"
...
dashboard: check
	...
	$(PYTHON) $(DASHBOARD) \
		...
		--capsule-frontier-window $(DASH_CAPSULE_FRONTIER_WINDOW) \
		--capsule-mint-parent-pool $(DASH_CAPSULE_MINT_PARENT_POOL) \
		--season-topology-jitter $(DASH_SEASON_TOPOLOGY_JITTER) \
		--chaos-min-substeps $(DASH_CHAOS_MIN_SUBSTEPS) \
		--chaos-max-substeps $(DASH_CHAOS_MAX_SUBSTEPS) \
		--chaos-substep-cost $(DASH_CHAOS_SUBSTEP_COST) \
		--host $(DASH_HOST) \
		--port $(DASH_PORT) \
